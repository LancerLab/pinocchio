...
from pinocchio.errors import (  # Circuit breaker; Specific exceptions; Logging
    CircuitBreaker,
...
class TestSpecificExceptions:
    ...
    def test_config_validation_error(self):
        ...
        error = ConfigValidationError(
            "Invalid configuration", details={"field": "api_key", "reason": "missing"}
        )
    ...
    def test_workflow_task_error(self):
        ...
        error = WorkflowTaskError(
            "Task execution failed", details={"task_id": "123", "step": "preprocessing"}
        )
...
class TestLogFormatters:
    ...
    def test_json_formatter_with_error_context(self):
        ...
        record.error_context = {"function": "test_function", "error_code": "TEST_ERROR"}
