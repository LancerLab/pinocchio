...
from tests.utils import create_test_session, create_test_session_metadata
...
class TestSessionMetadata:
    ...
    def test_session_metadata_creation(self):
        ...
        session = create_test_session(
            ...
            metadata={"name": "Test Session", "tags": ["test", "example"]},
        )
        ...
        assert session.session_id.startswith("test_session")
        assert session.metadata is not None

    def test_session_metadata_defaults(self):
        """Test SessionMetadata defaults."""
        session = create_test_session_metadata(
    ...
    def test_mark_completed(self):
        ...
        # Create session with specific creation time to avoid timezone issues
        ...
        # Runtime should be positive since we control the timing
