...
class WorkflowError(PinocchioError):
    ...
    def __init__(
        ...
        """
        Initialize a new WorkflowError.
...
class KnowledgeError(PinocchioError):
    ...
    def __init__(
        ...
        """
        Initialize a new KnowledgeError.
...
class LLMRateLimitError(LLMError):
    ...
    def __init__(
        ...
        """
        Initialize a new LLMRateLimitError.
...
class LLMAuthenticationError(LLMError):
    ...
    def __init__(
        ...
        """
        Initialize a new LLMAuthenticationError.
...
class LLMContentFilterError(LLMError):
    ...
    def __init__(
        ...
        """
        Initialize a new LLMContentFilterError.
...
class LLMTimeoutError(LLMError):
    ...
    def __init__(
        ...
        """
        Initialize a new LLMTimeoutError.
...
class LLMQuotaExceededError(LLMError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "LLM_QUOTA_EXCEEDED",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new LLMQuotaExceededError.
...
class LLMInvalidRequestError(LLMError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "LLM_INVALID_REQUEST",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new LLMInvalidRequestError.
...
class ConfigFileNotFoundError(ConfigError):
    ...
    def __init__(
        ...
        """
        Initialize a new ConfigFileNotFoundError.
...
class ConfigKeyError(ConfigError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "CONFIG_KEY_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new ConfigKeyError.
...
class ConfigTypeError(ConfigError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "CONFIG_TYPE_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new ConfigTypeError.
...
class WorkflowTaskError(WorkflowError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "WORKFLOW_TASK_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new WorkflowTaskError.
...
class WorkflowDefinitionError(WorkflowError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "WORKFLOW_DEFINITION_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new WorkflowDefinitionError.
...
class WorkflowTimeoutError(WorkflowError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "WORKFLOW_TIMEOUT",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new WorkflowTimeoutError.
...
class WorkflowCancelledError(WorkflowError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "WORKFLOW_CANCELLED",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new WorkflowCancelledError.
...
class KnowledgeResourceNotFoundError(KnowledgeError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "KNOWLEDGE_RESOURCE_NOT_FOUND",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new KnowledgeResourceNotFoundError.
...
class KnowledgeResourceInvalidError(KnowledgeError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "KNOWLEDGE_RESOURCE_INVALID",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new KnowledgeResourceInvalidError.
...
class KnowledgeVersionError(KnowledgeError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "KNOWLEDGE_VERSION_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new KnowledgeVersionError.
...
class AgentInitializationError(AgentError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "AGENT_INITIALIZATION_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new AgentInitializationError.
...
class AgentTimeoutError(AgentError):
    ...
    def __init__(
        ...
        """
        Initialize a new AgentTimeoutError.
...
class MemoryStorageError(MemoryError):
    ...
    def __init__(
        ...
        """
        Initialize a new MemoryStorageError.
...
class MemoryRetrievalError(MemoryError):
    ...
    def __init__(
        ...
        """
        Initialize a new MemoryRetrievalError.
...
class MemoryCorruptionError(MemoryError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "MEMORY_CORRUPTION_ERROR",
        details: Optional[Dict[str, Any]] = None,
    ):
        """
        Initialize a new MemoryCorruptionError.
