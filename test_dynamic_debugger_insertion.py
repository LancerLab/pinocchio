"""Test dynamic debugger insertion logic."""
import asyncio
...
async def test_dynamic_debugger_insertion():
    """Test dynamic debugger insertion logic."""
    config = Settings()
    ...
    print("✅ Dynamic debugger insertion test passed!")


if __name__ == "__main__":
    asyncio.run(test_dynamic_debugger_insertion())
